...
"""
One of the degrees of enforcemen may be specified by passing
the 'debug' keyword argument to the decorator:
    0 -- NONE:   No type-checking. Decorators disabled.
    1 -- MEDIUM: Print warning messsage to stderr. (Default)
...
def returns(ret_type, **kwargs):
    ...
    Parameters:
        ret_type -- The expected type of the decorated function's return value.
                    Must specify type for each parameter.
        kwargs   -- Optional specification of 'debug' level (this is the only
